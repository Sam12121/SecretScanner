...
```bash
$ docker run -it --rm toaeio/toae_secret_scanner:2.0.0 --help
```
...
For other settings, refer to the [sample config.yaml file](https://github.com/Sam12121/SecretScanner/tree/master/config.yaml)