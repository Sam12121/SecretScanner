...
WORKDIR /home/toae/src/SecretScanner
COPY . .
RUN make clean
RUN make
...
ENV MGMT_CONSOLE_URL=toae-internal-router \
...
COPY --from=builder /home/toae/src/SecretScanner/SecretScanner .
COPY --from=builder /home/toae/src/SecretScanner/config.yaml .
WORKDIR /home/toae/output

ENTRYPOINT ["/home/toae/usr/SecretScanner", "-config-path", "/home/toae/usr"]
CMD ["-h"]
